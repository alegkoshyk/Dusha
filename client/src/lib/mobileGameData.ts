...
export const mobileGameCards: GameCard[] = [
  // SOUL LEVEL CARDS
  {
    ...
    description: "Ласкаво просимо до трансформаційної гри 'Душа Бренду'! Готові відкрити унікальну суть вашого бренду?",
    shortDescription: "Старт подорожі",
    type: "choice",
    difficulty: "easy",
    estimatedTime: 2,
    required: true,
    options: [
      {
        ...
        label: "Так, я готовий!",
        icon: "🚀",
        description: "Розпочати подорож самопізнання",
        nextCard: "soul-values"
      },
      {
        id: "learn-more",
        label: "Хочу дізнатися більше",
        icon: "📖",
        description: "Дізнатися про процес гри",
        nextCard: "soul-intro"
      }
    ],
    rewards: {

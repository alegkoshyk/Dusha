...
import { ArrowLeft, Database, RefreshCw, Upload, Check, X, AlertCircle, Loader2 } from "lucide-react";
      ...
      <div className="container mx-auto py-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-2">Перенесення даних з Development у Production</p>
          </div>
